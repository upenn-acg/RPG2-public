...
void insert_machine_code(void){
   ...
   if (i==0){
      ...
      string cmd2 = "" + pg2_environ.bolted_function_bin;
      string cmd3 = "" + pg2_environ.call_sites_bin;
      string cmd5 = "" + pg2_environ.debug_log0;
      ...
      string cmd1 = "" + pg2_environ.prefetch_insn_bin;
      string cmd5 = "" + pg2_environ.debug_log;
