            ...
            switch( CLASS )
            {
                case 'S':
                    if( i <= 2 )
                    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 1: "
                    ...
                    else
                    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 2: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
                            */
                        }
                ...
                case 'W':
                    if( i < 2 )
                    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 3: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
                            */
                        }
                    ...
                    else
                    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 4: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
                            */
                        }
                    ...
                    if( i <= 2 )
        	    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 5: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
                            */
                        }
                    ...
                    else
                    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 6: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
                            */
                        }
                    ...
                    if( i == 1 || i == 2 || i == 4 )
        	    {
                        ...
                        {
            /*
			  printf("key_buff1[k-1]: %d\n", key_buff1[k-1]);
			  printf("testrankarray[i] + iteration: %d\n", test_rank_array[i] + iteration);
                            printf( "Failed partial verification 7: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
             */
                        }
             ...
             /*
               ...
               */
                    ...
                    else
                    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 8: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
                            */
                        }
                    ...
                    if( i <= 2 )
        	    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 9: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
                            */
                        }
                    ...
                    else
                    {
                        ...
                        {
                           /*
                            printf( "Failed partial verification 10: "
                                  "iteration %d, test key %d\n", 
                                   iteration, i );
                            */
                        }
