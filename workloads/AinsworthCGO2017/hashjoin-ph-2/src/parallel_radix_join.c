                     ...
                     relation_t * const tmpR)
{
    ...
    if (counter%4000==0)
      printf("the execution time of bucket_chaining_join is %f\n", cpu_time_used);
              ...
              int D)
{
    ...
    if (counter%50==0)
      printf("the execution time of radix_cluster is %f\n", cpu_time_used);
}
...
parallel_radix_partition(part_t * const part) 
{
    ...
    cpu_time_used += ((double) (end - start)) / CLOCKS_PER_SEC;
      ...
      printf("the execution time of parallel_radix_partition is %f\n", cpu_time_used);
